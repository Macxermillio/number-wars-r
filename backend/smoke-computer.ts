...
const r3 = opt.type === "move" ? applyMove(sim3, opt) : { error: "heuristic must return a move" };
...
const { applyAction } = await import("./server/ai/simulation.ts");
const r4 = applyAction(sim4, mm);
